#############################################################################
# Makefile for building: thaumia
# Generated by qmake (3.1) (Qt 5.10.0)
# Project:  thaumia.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile thaumia.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -isystem /usr/include/freetype2 -I/usr/lib/qt/mkspecs/linux-clang
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = thaumia1.0.0
DISTDIR = /home/byte/workspace/thaumia/.tmp/thaumia1.0.0
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++
LIBS          = $(SUBLIBS) -lGL -lGLEW -lglfw -lfreeimage -lfreetype 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		cvar.h \
		fps.h \
		context_functions.h main.c
QMAKE_TARGET  = thaumia
DESTDIR       = 
TARGET        = thaumia
...
Makefile: thaumia.pro /usr/lib/qt/mkspecs/linux-clang/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		thaumia.pro
	$(QMAKE) -o Makefile thaumia.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
